<?php /* Smarty version Smarty-3.1.21, created on 2017-06-14 16:41:09
         compiled from "D:\xampp\htdocs\tiki\templates\tiki-searchresults.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2577459414b0574d486-11692324%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1ce9684d6bd9c3b58711296419cc1c3c512ddec1' => 
    array (
      0 => 'D:\\xampp\\htdocs\\tiki\\templates\\tiki-searchresults.tpl',
      1 => 1496331455,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2577459414b0574d486-11692324',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59414b0be32867_07019624',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59414b0be32867_07019624')) {function content_59414b0be32867_07019624($_smarty_tpl) {?><?php if (!is_callable('smarty_block_title')) include 'D:/xampp/htdocs/tiki/lib/smarty_tiki\\block.title.php';
...
if (!is_callable('smarty_function_page_in_structure')) include 'D:/xampp/htdocs/tiki/lib/smarty_tiki\\function.page_in_structure.php';
if (!is_callable('smarty_function_page_alias')) include 'D:/xampp/htdocs/tiki/lib/smarty_tiki\\function.page_alias.php';
...
Search<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_title(array('admpage'=>"search",'help'=>"Search"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
" name="highlight" class="form-control" type="text" accesskey="s" placeholder="Search" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['words']->value);?>
">
				<!--/div-->
							...
							<?php if (count($_smarty_tpl->tpl_vars['categories']->value)>0) {?>
								...
								<div class="clearfix">
									<?php if ($_smarty_tpl->tpl_vars['tiki_p_admin_categories']->value=='y') {?>
										<div class="pull-right"><a href="tiki-admin_categories.php" class="link">Admin Categories <?php echo smarty_function_icon(array('name'=>'wrench'),$_smarty_tpl);?>
</a></div>
									<?php }?>
...
"><?php }?>
			...
			<?php if (!$_smarty_tpl->tpl_vars['searchNoResults']->value) {?>
				<?php echo smarty_function_button(array('_auto_args'=>'highlight','href'=>"tiki-searchresults.php?highlight=",'_text'=>"Clear Filter"),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->tpl_vars['searchStyle']->value!='menu'&&!$_smarty_tpl->tpl_vars['searchNoResults']->value) {?>
	<div class="nohighlight simplebox" style="width:300px">
		Found "<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['words']->value);?>
" in
...
" <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['where_forum']->value);?>
 ...
 "<?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array()); $_block_repeat=true; echo smarty_block_tr(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();
echo smarty_modifier_escape($_smarty_tpl->tpl_vars['where_label']->value);?>
"<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tr(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
echo smarty_modifier_escape($_smarty_tpl->tpl_vars['results']->value[$_smarty_tpl->getVariable('smarty')->value['section']['search']['index']]['pageName']);
				...
				<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_search_show_visit_count']=='y') {?>
					<span class="itemhits">(Hits: <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['results']->value[$_smarty_tpl->getVariable('smarty')->value['section']['search']['index']]['hits']);?>
)</span>
				<?php }?>
				...
				<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_search_show_pertinence']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feature_search_fulltext']=='y') {?>
					<span class="itemrelevance">
						<?php if ($_smarty_tpl->tpl_vars['results']->value[$_smarty_tpl->getVariable('smarty')->value['section']['search']['index']]['relevance']<=0) {?>
							(Simple search)
						<?php } else { ?>
							(Relevance: <?php echo $_smarty_tpl->tpl_vars['results']->value[$_smarty_tpl->getVariable('smarty')->value['section']['search']['index']]['relevance'];?>
)
						<?php }?>
					</span>
				<?php }?>
...
echo smarty_modifier_escape(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['results']->value[$_smarty_tpl->getVariable('smarty')->value['section']['search']['index']]['data']));
		...
		<?php endfor; else: ?>
<li>No pages matched the search criteria </li>		<?php endif; ?>
	</ul>
