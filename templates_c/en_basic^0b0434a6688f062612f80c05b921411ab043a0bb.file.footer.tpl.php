...
if (!is_callable('smarty_function_debugger')) include 'D:/xampp/htdocs/tiki/lib/smarty_tiki\\function.debugger.php';
if (!is_callable('smarty_block_wikiplugin')) include 'D:/xampp/htdocs/tiki/lib/smarty_tiki\\block.wikiplugin.php';
if (!is_callable('smarty_function_interactivetranslation')) include 'D:/xampp/htdocs/tiki/lib/smarty_tiki\\function.interactivetranslation.php';
?>
...
<?php if ((($tmp = @$_smarty_tpl->tpl_vars['module_pref_errors']->value)===null||$tmp==='' ? null : $tmp)) {?>
	<div class="container<?php if ($_SESSION['fullscreen']=='y') {?>-fluid<?php }?> modules">
